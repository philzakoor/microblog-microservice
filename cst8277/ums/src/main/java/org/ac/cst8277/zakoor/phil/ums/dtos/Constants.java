...
public class Constants {
    ...
    public static final String GET_USER_ROLE = "SELECT * FROM " + TABLE_USERS + " LEFT JOIN " + TABLE_USERS_ROLES + " ON "
            + TABLE_USERS_ROLES + ".`users_id` = " + TABLE_USERS + ".`id` LEFT JOIN " + TABLE_ROLES + " ON "
            + TABLE_USERS_ROLES + ".`roles_id` = " + TABLE_ROLES + ".`id` WHERE " + TABLE_USERS + ".`id` = ?";
    public static final String LOGIN = "SELECT `id` FROM " + TABLE_USERS + " WHERE " + TABLE_USERS + ".`email` = ? AND "
